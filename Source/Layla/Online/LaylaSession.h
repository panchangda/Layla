...
#include "Online.h"
#include "LaylaSession.generated.h"
// Copyright Epic Games, Inc. All Rights Reserved.


struct FLaylaSessionParams
{
...
UCLASS(config=Game)
class ALaylaSession : public AGameSession
{
...
protected:
	...
	FLaylaSessionParams CurrentSessionParams;
	/** Current host settings */
	TSharedPtr<class FLaylaOnlineSessionSettings> HostSettings;
	/** Current search settings */
	TSharedPtr<class FLaylaOnlineSearchSettings> SearchSettings;
	 ...
	 */
	DECLARE_EVENT_TwoParams(ALaylaSession, FOnCreatePresenceSessionComplete, FName /*SessionName*/, bool /*bWasSuccessful*/);
	...
	DECLARE_EVENT_OneParam(ALaylaSession, FOnJoinSessionComplete, EOnJoinSessionCompleteResult::Type /*Result*/);
	FOnJoinSessionComplete JoinSessionCompleteEvent;

	/*
	 * Event triggered after session search completes
	 */
	//DECLARE_EVENT(ALaylaSession, FOnFindSessionsComplete);
	DECLARE_EVENT_OneParam(ALaylaSession, FOnFindSessionsComplete, bool /*bWasSuccessful*/);
